            ...
            <ul className="resource-links">
                <li>
                    <a target="_blank" href={useBaseUrl(
                        "generative-ai/vector-rag-embedding/videos/BTP%20AI%20Best%20Practices%20-%20Vector-based%20RAG%20Embedding.mp4")}>
                        <Icon name="video"/>
                        <span>Teaser</span>
                    </a>
                </li>
                <LoginWall renderOnlyWhenLoggedIn={true}>
                    ...
                    <li>
                        <a target="_blank" href={useBaseUrl(
                            "generative-ai/vector-rag-embedding/pdfs/BTP%20AI%20Best%20Practices%20-%20Vector-based%20RAG%20Embedding.pdf")}>
...
Vector databases and Retrieval Augmented Generation ([RAG](https://sap.sharepoint.com/sites/210313/SitePages/Glossary.aspx#rag)) are pivotal in enhancing the capabilities of AI systems, particularly in the realm of semantic search and natural language processing. Vector databases, such as those supported by [SAP HANA Cloud](https://sap.sharepoint.com/sites/209475/SitePages/Vector-Engine.aspx), store data in high-dimensional vector formats, allowing for efficient similarity searches. These databases are crucial for applications like semantic search, recommendations, and anomaly detection. RAG, on the other hand, leverages vector databases to augment the intelligence of [large language models (LLMs)](https://sap.sharepoint.com/sites/210313/SitePages/Glossary.aspx#llm-%28large-language-model%29) by integrating external information retrieval into the response generation process.
...
1. **Vector Embeddings:**  [Vector embeddings](https://sap.sharepoint.com/sites/210313/SitePages/Glossary.aspx#vector-embeddings) are vectors generated by embedding models to map objects like text or images into a high-dimensional space, preserving semantic similarity.
...
3. **REAL_VECTOR Data Type:** In SAP HANA Cloud, vectors are stored using the [REAL_VECTOR](https://sap.sharepoint.com/sites/210313/SitePages/GenAI%20-%20RAG%20-%20Vector%20Database%20-%20Overall%20and%20Embedding%20Creation.aspx#:~:text=stored%20using%20the-,REAL_VECTOR,-data%20type%2C%20which) data type, which supports operations like creation, serialization, and similarity searches but has limitations such as no defined order and restrictions on arithmetic operations.
4. **Chunking:** Chunking in Retrieval-Augmented Generation (RAG) refers to the process of dividing large text corpora into smaller, manageable pieces known as chunks. Please refer [Chunking strategies](https://sap.sharepoint.com/sites/210313/SitePages/GenAI%20-%20RAG%20-%20Vector%20Database%20-%20Overall%20and%20Embedding%20Creation.aspx#chunking-in-rag) for more details.
...
![xample Process Flow for a Vector Engine-powered RAG approach](@site/static/generative-ai/vector-rag-embedding/images/Process_Flow_for_a_Vector_Engine.png)
...
1. Setup SAP Business Technology Platform (SAP BTP) subaccount ([Setup Guide](https://sap.sharepoint.com/sites/210313/SitePages/SAP%20Business%20Technology%20Platform%20(SAP%20BTP).aspx))
2. Create an instance of SAP HANA Cloud ([Setup Guide](https://sap.sharepoint.com/sites/210313/SitePages/Technology%20-%20SAP%20HANA%20Cloud.aspx))
3. Create an instance of SAP AI Core ([Setup Guide](https://sap.sharepoint.com/sites/210313/SitePages/Technology%20-%20SAP%20AI%20Core.aspx#setup))
4. Subscribe to SAP AI Launchpad ([Setup Guide](https://sap.sharepoint.com/sites/210313/SitePages/Technology%20-%20SAP%20AI%20Launchpad.aspx))
...
<TabItem value="python" label="Python" default>
    ...
    <TrackableLink
        href="https://github.com/SAP-samples/sap-btp-ai-best-practices/tree/main/best-practices/vector-rag-embedding/python"
...
<TabItem value="javascript-typescript" label="JavaScript/TypeScript">
    ...
    <TrackableLink
        href="https://github.com/SAP-samples/sap-btp-ai-best-practices/tree/main/best-practices/vector-rag-embedding/typescript"
        className="button button--primary button--lg download-source-btn--tab"
        target="_blank"
        trackingFeature="DOWNLOAD_ACCESS_TO_GEN_AI_MODELS">
        <span>Download Source Code</span>
...
- [SAP Cloud SDK for AI - Compute Embedding](https://github.com/SAP/ai-sdk-js/blob/main/sample-code/src/foundation-models/azure-openai.ts) (Look at the computeEmbedding() function to create embeddings to store in a Vector Database)
- [SAP Cloud SDK for AI - Document Grounding](https://github.com/SAP/ai-sdk-js/blob/main/sample-code/src/document-grounding.ts) (To use the Document Grounding feature)
...
<TabItem value="cap-app" label="CAP">
    ...
    <TrackableLink
        href="https://github.com/SAP-samples/sap-btp-ai-best-practices/tree/main/best-practices/vector-rag-embedding/cap"
        className="button button--primary button--lg download-source-btn--tab"
        target="_blank"
        trackingFeature="DOWNLOAD_ACCESS_TO_GEN_AI_MODELS">
        <span>Download Source Code</span>
...
<h3><a href={useBaseUrl("/docs/functional-view/content-creation")}>Content Creation</a></h3>
...
<h3><a href={useBaseUrl("/docs/functional-view/information-analysis-and-processing")}>Information Analysis & Processing</a></h3>
