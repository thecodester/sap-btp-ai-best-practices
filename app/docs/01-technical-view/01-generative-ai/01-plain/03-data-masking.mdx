...
1. Set up a SAP Business Technology Platform (SAP BTP) subaccount ([Setup Guide](https://sap.sharepoint.com/sites/210313/SitePages/SAP%20Business%20Technology%20Platform%20(SAP%20BTP).aspx)).
2. Deploy SAP AI Core with extended service plan ([Setup Guide](https://sap.sharepoint.com/sites/210313/SitePages/Technology%20-%20SAP%20AI%20Core.aspx#setup)).
3. Configure the Orchestration service in AI Launchpad - ([Setup Guide](https://sap.sharepoint.com/sites/210313/SitePages/Technology%20-%20SAP%20AI%20Launchpad.aspx)).
...
<h3><a href={useBaseUrl("/docs/functional-view/conversational-interaction")}>Conversational Interaction</a></h3>
