...
- **[SAP BTP AI Best Practices - Sample Code](https://github.com/SAP-samples/sap-btp-ai-best-practices/tree/main/best-practices/access-to-generative-ai-models/python)**
- [btp-gen-ai-hub-sdk-samples](https://github.com/SAP-samples/btp-gen-ai-hub-sdk-samples) - SAP Generative AI hub SDK samples repository. See the specific file [`2-connect-genaihub-from-env.ipynb`](https://github.com/SAP-samples/btp-gen-ai-hub-sdk-samples/blob/main/docs/notebook-samples/2-connect-genaihub-from-env.ipynb) for connecting to GenAI Hub from environment.
...
- **[SAP BTP AI Best Practices - Sample Code](https://github.com/SAP-samples/sap-btp-ai-best-practices/tree/main/best-practices/access-to-generative-ai-models/typescript)**
- [SAP Cloud SDK for AI - Sample Code](https://github.com/SAP/ai-sdk-js/tree/main/sample-code) - See the specific file [`orchestration.ts`](https://github.com/SAP/ai-sdk-js/blob/main/sample-code/src/orchestration.ts) for the `orchestrationChatCompletion` function implementation.
...
- **[SAP BTP AI Best Practices - Sample Code](https://github.com/SAP-samples/sap-btp-ai-best-practices/tree/main/best-practices/access-to-generative-ai-models/cap)**
- [SAP Cloud SDK for AI - Sample CAP](https://github.com/SAP/ai-sdk-js/tree/main/sample-cap) - See the specific file [`orchestration-service.ts`](https://github.com/SAP/ai-sdk-js/blob/main/sample-cap/srv/orchestration/orchestration-service.ts) for the `OrchestrationService` class implementation.
...
- **[SAP BTP AI Best Practices - Sample Code](https://github.com/SAP-samples/sap-btp-ai-best-practices/tree/main/best-practices/access-to-generative-ai-models/java)**
- [Sample Spring App example](https://github.com/SAP/ai-sdk-java/tree/main/sample-code/spring-app) - See the specific files [`OpenAiService.java`](https://github.com/SAP/ai-sdk-java/blob/main/sample-code/spring-app/src/main/java/com/sap/ai/sdk/app/controllers/OpenAiController.java) and [`OpenAiController.java`](https://github.com/SAP/ai-sdk-java/blob/main/sample-code/spring-app/src/main/java/com/sap/ai/sdk/app/controllers/OpenAiController.java) to interact with the service.
