...
- Configuring User-Specific Settings (Step 2 of the Learning Journey) from Generative AI with SAP AI Core

<h3>Reference Code</h3>

- SAP BTP AI Best Practices - Sample Code
- Sample Spring App example (Refer to service ai-sdk-java/…/services/SpringAiOrchestrationService.java and the controller to interact with the service ai-sdk-java/…/controllers/OrchestrationController.java)
