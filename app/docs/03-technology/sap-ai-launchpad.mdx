...
1. Subscribe to the AI Launchpad service with extended service plan ([SAP Help](https://help.sap.com/docs/ai-launchpad/sap-ai-launchpad/subscribe-to-sap-ai-launchpad))

2. Allow access to the needed users to the AI Launchpad service ([SAP Help](https://help.sap.com/docs/ai-launchpad/sap-ai-launchpad/allow-access-to-sap-ai-launchpad))
...
- [End-to-end use case](https://help.sap.com/docs/ai-launchpad/sap-ai-launchpad/example-end-to-end-use-case)
