...
Subscribe to the AI Launchpad service with extended service plan ([SAP Help](https://help.sap.com/docs/ai-launchpad/sap-ai-launchpad/subscribe-to-sap-ai-launchpad))

Allow access to the needed users to the AI Launchpad service ([SAP Help](https://help.sap.com/docs/ai-launchpad/sap-ai-launchpad/allow-access-to-sap-ai-launchpad))
