  ...
  <div className="row">
    ...
    <div className="col col--4">
      <ul className="resource-links">
        <li>
          <Link target="_blank" to={useBaseUrl("narrow-ai/anomaly-detection/videos/BTP AI Best Practices - Anomaly Detection (intro)_external.mp4")}>
            <Icon name="video" />
            <span>Teaser</span>
          </Link>
        </li>
        <LoginWall renderOnlyWhenLoggedIn={true}>
          <li>
            <Link target="_blank" to={useBaseUrl("narrow-ai/anomaly-detection/videos/BTP AI Best Practices - Anomaly Detection.mp4")}>
              <Icon name="video" />
              <span>Webinar</span>
            </Link>
          </li>
