---
title: "Deployment of Custom Predictive Models"
description: ""
hide_title: true
...
<div className="hero-header">
  <h1>Deployment of Custom Predictive Models</h1>
</div>
  ...
  <div className="row">
    ...
    <div className="col col--4">
      <ul className="resource-links">
        <li>
          <Link target="_blank" to={useBaseUrl("narrow-ai/deployment-custom-predictive-models/videos/#TODO")}>
            <Icon name="video" />
        ...
        <LoginWall renderOnlyWhenLoggedIn={true}>
          ...
          <li>
            <Link target="_blank" to={useBaseUrl("narrow-ai/deployment-custom-predictive-models/pdfs/#TODO")}>
...
<LoginWall renderOnlyWhenLoggedIn={true}>
  <TrackableLink
    href="https://github.com/SAP-samples/sap-btp-ai-best-practices/tree/main/best-practices/narrow-ai/deployment-custom-predictive-models"
    className="button button--primary button--lg download-source-btn"
    target="_blank"
    trackingFeature="DOWNLOAD_DEPLOYMENT_CUSTOM_PREDICTIVE_MODELS"
  >
...
<TrackableLink
  href="https://github.com/SAP-samples/sap-btp-ai-best-practices/tree/main/best-practices/narrow-ai/deployment-custom-predictive-models/python"
...
<TrackableLink
  href="https://github.com/SAP-samples/sap-btp-ai-best-practices/tree/main/best-practices/narrow-ai/deployment-custom-predictive-models/typescript"
  className="button button--primary button--lg download-source-btn--tab"
  target="_blank"
  trackingFeature="DOWNLOAD_DEPLOYMENT_CUSTOM_PREDICTIVE_MODELS"
>
...
<TrackableLink
  href="https://github.com/SAP-samples/sap-btp-ai-best-practices/tree/main/best-practices/narrow-ai/deployment-custom-predictive-models/cap"
  className="button button--primary button--lg download-source-btn--tab"
  target="_blank"
  trackingFeature="DOWNLOAD_DEPLOYMENT_CUSTOM_PREDICTIVE_MODELS"
>
