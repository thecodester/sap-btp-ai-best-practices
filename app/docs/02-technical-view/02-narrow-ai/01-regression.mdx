...
<IconLinkButton href="/docs/technical-view/narrow-ai/time-series-forecasting"
text="Time Series Forecasting"/>
<IconLinkButton href="/docs/technical-view/narrow-ai/classification"
text="Classification"/>
</ul>
...
<ul className="button-grid">
<IconLinkButton href="/docs/functional-view/decision-support/forecasting-historical-data"
text="Forecasting based on Historical Data"/>
</ul>
