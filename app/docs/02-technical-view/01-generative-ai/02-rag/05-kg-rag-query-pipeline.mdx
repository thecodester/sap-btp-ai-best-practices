---
title: "Graph-based RAG KG Query Pipeline"
description: ""
hide_title: true
...
<div className="hero-header">
  <h1>Graph-based RAG KG Query Pipeline</h1>
</div>
...
<TrackableLink
  href="https://github.com/SAP-samples/sap-btp-ai-best-practices/tree/main/best-practices/generative-ai/kg-rag-query-pipeline/python"
...
<TrackableLink
  href="https://github.com/SAP-samples/sap-btp-ai-best-practices/tree/main/best-practices/generative-ai/kg-rag-query-pipeline/typescript"
  className="button button--primary button--lg download-source-btn--tab"
  target="_blank"
  trackingFeature="DOWNLOAD_KG_RAG_QUERY_PIPELINE"
>
...
<TrackableLink
  href="https://github.com/SAP-samples/sap-btp-ai-best-practices/tree/main/best-practices/generative-ai/kg-rag-query-pipeline/cap"
  className="button button--primary button--lg download-source-btn--tab"
  target="_blank"
  trackingFeature="DOWNLOAD_KG_RAG_QUERY_PIPELINE"
>
