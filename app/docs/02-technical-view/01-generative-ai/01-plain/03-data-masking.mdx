  ...
  <div className="row">
    ...
    <div className="col col--4">
      <ul className="resource-links">
        <li>
          <Link target="_blank" to={useBaseUrl("generative-ai/data-masking/videos/BTP%20AI%20Best%20Practices%20-%20Data%20Masking%20intro.mp4")}>
            <Icon name="video" />
            <span>Teaser</span>
          </Link>
        </li>
        <LoginWall renderOnlyWhenLoggedIn={true}>
          <li>
            <Link target="_blank" to={useBaseUrl("generative-ai/data-masking/videos/BTP%20AI%20Best%20Practices%20-%20Data%20Masking.mp4")}>
              <Icon name="video" />
              <span>Webinar</span>
            </Link>
          </li>
          <li>
            <Link target="_blank" to={useBaseUrl("generative-ai/data-masking/pdfs/BTP%20AI%20Best%20Practices%20-%20Data%20masking.pdf")}>
...
<LoginWall renderOnlyWhenLoggedIn={true}>
  <TrackableLink
    href="https://github.com/SAP-samples/sap-btp-ai-best-practices/tree/main/best-practices/generative-ai/data-masking"
...
To see the full list of PII detected by **AI Core** anonymisation and pseudonymization service you can refer to this [wiki](https://help.sap.com/docs/sap-ai-core/sap-ai-core-service-guide/data-masking?locale=en-US).
...
<TrackableLink
  href="https://github.com/SAP-samples/sap-btp-ai-best-practices/tree/main/best-practices/generative-ai/data-masking/python"
...
<TabItem value="javascript-typescript" label="JavaScript/TypeScript">
    ...
    <TrackableLink
        href="https://github.com/SAP-samples/sap-btp-ai-best-practices/tree/main/best-practices/generative-ai/data-masking/typescript"
        className="button button--primary button--lg download-source-btn--tab"
        target="_blank"
        trackingFeature="DOWNLOAD_DATA_MASKING">
        <span>Download Source Code</span>
...
<TrackableLink
  href="https://github.com/SAP-samples/sap-btp-ai-best-practices/tree/main/best-practices/generative-ai/data-masking/cap"
  className="button button--primary button--lg download-source-btn--tab"
  target="_blank"
  trackingFeature="DOWNLOAD_DATA_MASKING"
>
...
<TrackableLink
  href="https://github.com/SAP-samples/sap-btp-ai-best-practices/tree/main/best-practices/generative-ai/data-masking/java"
  className="button button--primary button--lg download-source-btn--tab"
  target="_blank"
  trackingFeature="DOWNLOAD_DATA_MASKING"
>
