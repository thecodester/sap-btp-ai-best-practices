...
Defined AI use-case are then implemented as SAP BTP applications (a standalone application, a extension, an analytics, etc.). We offer a direct connection from the AI capabilities to the guidelines for implementation, leveraging oneor more Best Practices.
