...
- SAP Business Technology Platform (SAP BTP) subaccount ([Setup Guide](#)) **TODO: Create BTP Page**
- SAP AI Core ([Setup Guide](#)) **TODO: Create AI Core Page**
...
[SAP Business Technology Platform (BTP)](#) **TODO: Create BTP Page** is an integrated suite of cloud services, databases, AI, and development
tools that enable businesses to build, extend, and integrate SAP and non-SAP applications efficiently.

#### SAP AI Core

[SAP AI Core](#) **TODO: Create AI Core Page** is a managed AI runtime that enables scalable execution of AI models and pipelines, integrating
